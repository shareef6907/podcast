...
export default function Booking() {
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      // In a real app, you would send the form data to your backend or API
    ...
    <>
      ...
      <div className="bg-black text-white py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl max-w-3xl mx-auto">Reserve your professional podcast recording with our team</p>
        </div>
      </div>
                ...
                {!submitSuccess ? (
                  <form onSubmit={handleSubmit} className="p-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="mb-4 md:col-span-2">
                        <label htmlFor="location" className="block text-gray-700 font-bold mb-2">Recording Location *</label>
                        <input
                          type="text"
                          id="location"
                          name="location"
                      ...
                      <div className="mb-4">
                        <label htmlFor="duration" className="block text-gray-700 font-bold mb-2">Session Duration (hours) *</label>
                        <select
                          id="duration"
                          name="duration"
                      ...
                      <div className="mb-4">
                        ...
                        <select
                          ...
                          className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-gold"
                        >
                          <option value="standard">Standard (1 camera, 2 microphones)</option>
                          <option value="premium">Premium (2 cameras, 4 microphones)</option>
                          <option value="professional">Professional (3 cameras, 4 microphones, lighting)</option>
                          <option value="custom">Custom Setup</option>
                        </select>
                      </div>
                      
                      <div className="mb-4 md:col-span-2">
                        <label className="block text-gray-700 font-bold mb-2">Additional Services</label>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                          <div>
                            <label className="inline-flex items-center">
                              ...
                              />
                              <span className="ml-2">Post-production Editing</span>
                            </label>
                          </div>
                          <div>
                            <label className="inline-flex items-center">
                              <input
                                ...
                                className="form-checkbox h-5 w-5 text-gold"
                              />
                              <span className="ml-2">Professional Lighting</span>
                            </label>
                          </div>
                          <div>
                            <label className="inline-flex items-center">
                              <input
                                ...
                                className="form-checkbox h-5 w-5 text-gold"
                              />
                              <span className="ml-2">Custom Backdrop</span>
                            </label>
                          </div>
                          <div>
                            <label className="inline-flex items-center">
                              <input
                                ...
                                className="form-checkbox h-5 w-5 text-gold"
                              />
                              <span className="ml-2">Podcast Distribution</span>
                            </label>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="mb-4 md:col-span-2">
                        <label htmlFor="message" className="block text-gray-700 font-bold mb-2">Additional Comments</label>
                        <textarea
                          id="message"
                          name="message"
                      ...
                      <div className="mb-4 md:col-span-2">
                        <button
                          ...
                          className={`w-full py-3 px-6 rounded-full text-white font-bold ${isSubmitting ? 'bg-gray-500' : 'bg-gold hover:bg-darkgold'} transition duration-300`}
                        >
                  ...
                  <div className="p-8 text-center">
                    ...
                    <button
                      ...
                      className="py-2 px-6 bg-black text-white rounded-full hover:bg-gray-800 transition duration-300"
                    >
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4 text-center">
          <AnimatedSection>
            ...
            <p className="mb-6">Contact us directly via phone or WhatsApp for urgent bookings or inquiries.</p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <a href="tel:+97339007750" className="flex items-center justify-center gap-2 bg-black text-white py-2 px-6 rounded-full hover:bg-gray-800 transition duration-300">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                  <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z"></path>
                </svg>
                +973 3900 7750
              </a>
              <a href="https://wa.me/97339007750" className="flex items-center justify-center gap-2 bg-green-600 text-white py-2 px-6 rounded-full hover:bg-green-700 transition duration-300">
